              ...
              <div className="card">
                <div className="card-body">
                  <div className="number-widgets">
                    <div className="media">
                      <div className="media-body align-self-center">
                        <h6 className="mb-0">Work Process</h6>
                      </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="number-widgets">
                    <div className="media">
                      <div className="media-body align-self-center">
                        <h6 className="mb-0">Sale Completed</h6>
                      </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="number-widgets">
                    <div className="media">
                      <div className="media-body align-self-center">
                        <h6 className="mb-0">Payment Done</h6>
                      </div>
              ...
              <div className="card">
                ...
                <div className="card-body height-equal">
                  <div className="progress-block">
                    <div className="progress-title"><span>Basic Information</span><span className="pull-right">15/18</span></div>
                  ...
                  <div className="progress-block">
                    <div className="progress-title"><span>Legal Document</span><span className="pull-right">12/20</span></div>
                    <div className="progress" style={{ height: "3px" }}>
                  ...
                  <div className="progress-block">
                    <div className="progress-title"><span>Product Info</span><span className="pull-right">15/17</span></div>
                    <div className="progress" style={{ height: "3px" }}>
                  ...
                  <div className="progress-block mb-0">
                    <div className="progress-title"><span>Billing Details</span><span className="pull-right">2/5</span></div>
                    <div className="progress" style={{ height: "3px" }}>
                      <div className="progress-bar bg-primary" role="progressbar" style={{ width: "95%" }} aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                    ...
                    <table className="table table-bordernone">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>9</td>
                          <td>
                            <button className="btn btn-primary btn-pill">On Way</button>
                          </td>
                          <td>5500</td>
                          <td>
                            <X />
